        ...
        <div id="main" className="alt">
            <section id="one">
                <div className="inner">
					...
					<p>If you would like to contribute, please <a href="https://www.paypal.me/sarahdave2020" className="button icon fab fa-paypal" target="_blank">Paypal us</a> or we can give you our bank details.</p>
                </div>
            </section>
        </div>
